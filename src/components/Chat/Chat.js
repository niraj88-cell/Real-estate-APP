...
const Chat = ({chats}) => {
    ...
    const handleOpenChat = async (id, receiver) => {
      try {
          ...
          setChat({...res.data, receiver}); // Spread the response data and add the receiver
      } catch (err) {
                    ...
                    <div className="center">
                        ...
                        {chat.messages.map(message=>{
                             <div className="chatMessage" key={message.id} style={{
                                ...
                                textAlign: message.userId===currentUser.id ? "right" : "flex-start",
                             }}>
                             <p>{message.text}</p>
